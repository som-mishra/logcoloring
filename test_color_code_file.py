...
class TestParseTestResults(unittest.TestCase):
	...
	def test_get_all_tokens_valid1(self):
		...
		expected_tuple = "(date='2016-03-07', time='23:08:02.956', pid='26887', loglevel='WARNING', modulename='oslo_reports.guru_meditation_report', request='[-]')"
		self.assertEqual(expected_tuple, color_code_file.get_all_tokens(test_line1))
